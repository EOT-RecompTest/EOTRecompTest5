...
GUEST_FUNCTION_HOOK(__imp__NtWriteFileGather, reblue::kernel::NtWriteFileGather);
...
GUEST_FUNCTION_HOOK(__imp__KeSetCurrentProcessType, reblue::kernel::KeSetCurrentProcessType);
...
GUEST_FUNCTION_HOOK(__imp__VdSetDisplayModeOverride, reblue::kernel::VdSetDisplayModeOverride);
...
GUEST_FUNCTION_HOOK(__imp__MmSetAddressProtect, reblue::kernel::MmSetAddressProtect);
GUEST_FUNCTION_HOOK(__imp__MmMapIoSpace, reblue::kernel::MmMapIoSpace);
...
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetCleanup, reblue::kernel::NetDll_XNetCleanup);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetRandom, reblue::kernel::NetDll_XNetRandom);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetCreateKey, reblue::kernel::NetDll_XNetCreateKey);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetRegisterKey, reblue::kernel::NetDll_XNetRegisterKey);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetXnAddrToInAddr, reblue::kernel::NetDll_XNetXnAddrToInAddr);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetServerToInAddr, reblue::kernel::NetDll_XNetServerToInAddr);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetTsAddrToInAddr, reblue::kernel::NetDll_XNetTsAddrToInAddr);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetInAddrToXnAddr, reblue::kernel::NetDll_XNetInAddrToXnAddr);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetInAddrToString, reblue::kernel::NetDll_XNetInAddrToString);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetUnregisterInAddr, reblue::kernel::NetDll_XNetUnregisterInAddr);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetConnect, reblue::kernel::NetDll_XNetConnect);
GUEST_FUNCTION_HOOK(__imp__NetDll_XNetGetConnectStatus, reblue::kernel::NetDll_XNetGetConnectStatus);
GUEST_FUNCTION_HOOK(__imp__NetDll_ioctlsocket, reblue::kernel::NetDll_ioctlsocket);
GUEST_FUNCTION_HOOK(__imp__NetDll_recvfrom, reblue::kernel::NetDll_recvfrom);
GUEST_FUNCTION_HOOK(__imp__NetDll_sendto, reblue::kernel::NetDll_sendto);
GUEST_FUNCTION_HOOK(__imp__NetDll_WSAGetLastError, reblue::kernel::NetDll_WSAGetLastError);
GUEST_FUNCTION_HOOK(__imp__XNetLogonGetTitleID, reblue::kernel::XNetLogonGetTitleID);
...
GUEST_FUNCTION_HOOK(__imp__XAudioGetSpeakerConfig, reblue::kernel::XAudioGetSpeakerConfig);
...
GUEST_FUNCTION_HOOK(__imp__KeInsertQueueDpc, reblue::kernel::KeInsertQueueDpc);
GUEST_FUNCTION_HOOK(__imp__KeInitializeDpc, reblue::kernel::KeInitializeDpc);
...
GUEST_FUNCTION_HOOK(__imp__IoDismountVolume, reblue::kernel::IoDismountVolume);
...
GUEST_FUNCTION_HOOK(__imp__XamSessionRefObjByHandle, reblue::kernel::XamSessionRefObjByHandle);
GUEST_FUNCTION_HOOK(__imp__XamSessionCreateHandle, reblue::kernel::XamSessionCreateHandle);
GUEST_FUNCTION_HOOK(__imp__XamCreateEnumeratorHandle, reblue::kernel::XamCreateEnumeratorHandle);
GUEST_FUNCTION_HOOK(__imp__XamUserGetMembershipTierFromXUID, reblue::kernel::XamUserGetMembershipTierFromXUID);
GUEST_FUNCTION_HOOK(__imp__XamUserGetOnlineCountryFromXUID, reblue::kernel::XamUserGetOnlineCountryFromXUID);
...
GUEST_FUNCTION_HOOK(__imp__XexLoadImage, reblue::kernel::XexLoadImage);
GUEST_FUNCTION_HOOK(__imp__XexUnloadImage, reblue::kernel::XexUnloadImage);
